        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdTargetType = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartItem", x => new { x.MenuId, x.CartId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VoucherRedemptionStatus = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VoucherRedemption", x => new { x.UserID, x.VoucherID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResponseRating", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResponseRating_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResponseRating_Rating_RatingId",
                        column: x => x.RatingId,
                        principalTable: "Rating",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_UserName_PhoneNumber_Email",
                table: "AspNetUsers",
                columns: new[] { "UserName", "PhoneNumber", "Email" })
                .Annotation("Npgsql:IndexMethod", "GIN")
                .Annotation("Npgsql:TsVectorConfig", "vi_unaccent");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResponseRating_RatingId",
                table: "ResponseRating",
                column: "RatingId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ResponseRating_UserId",
                table: "ResponseRating",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Voucher_StartDate_EndDate",
                table: "Voucher",
